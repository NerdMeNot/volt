...
description: The atomic single-waiter fast slot pattern used in Semaphore and
  Channel for lock-free wakeup under contention.
slug: v1.0.0-zig0.15.2/v110/design/fast-waiter-slot
---
...
* Channel wakeup protocol: [Channel Wakeup Protocol](/v1.0.0-zig0.15.2/design/channel-wakeup-protocol/)
* Semaphore algorithm: [Semaphore Algorithm](/v1.0.0-zig0.15.2/algorithms/semaphore-algorithm/)
