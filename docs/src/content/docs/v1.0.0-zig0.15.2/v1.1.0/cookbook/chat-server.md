---
title: Chat Server
description: A multi-client chat server using BroadcastChannel for message
  fan-out with graceful disconnect handling.
slug: v1.0.0-zig0.15.2/v110/cookbook/chat-server
---
