---
title: Scheduler
description: Deep dive into the Volt work-stealing scheduler -- worker run loop,
  task queues, LIFO slot, parking protocol, and adaptive tuning.
slug: v1.0.0-zig0.15.2/v110/internals/scheduler
---
...
* **real\_head** -- The true consumer position (only the owner reads here).
* **steal\_head** -- The position up to which stealers have claimed slots.
