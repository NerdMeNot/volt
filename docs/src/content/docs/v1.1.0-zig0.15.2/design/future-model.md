...
description: "How Volt implements poll-based stackless futures, wakers, state machines, and composable combinators in Zig 0.15."
---
...
Volt's polling infrastructure, waker mechanism, and scheduler provide the runtime layer that `std.Io` does not include. See [Stackless vs Stackful](/design/stackless-vs-stackful/) for the full comparison.
