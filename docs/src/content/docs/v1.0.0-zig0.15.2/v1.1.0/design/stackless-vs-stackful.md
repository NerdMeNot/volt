...
description: Why Volt uses stackless futures instead of stackful coroutines,
  with detailed memory, performance, and architectural comparisons.
slug: v1.0.0-zig0.15.2/v110/design/stackless-vs-stackful
---
...
[zero-allocation waiters](/v1.0.0-zig0.15.2/design/zero-allocation-waiters) page). No heap
...
Volt targets Linux (x86\_64, aarch64), macOS (x86\_64, aarch64), and
Windows (x86\_64). Stackful coroutines would require:
...
| I/O backends | Threaded + proof-of-concept io\_uring, kqueue | io\_uring, kqueue, IOCP, epoll |
