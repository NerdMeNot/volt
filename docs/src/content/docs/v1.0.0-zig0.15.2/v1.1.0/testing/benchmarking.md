---
title: Benchmarking
description: How to run Volt benchmarks, interpret results, write new
  benchmarks, and profile performance.
slug: v1.0.0-zig0.15.2/v110/testing/benchmarking
---
...
* **bytes\_per\_op**: Heap bytes allocated per operation (tracked by a counting allocator wrapper).
* **allocs\_per\_op**: Number of heap allocation calls per operation.
* **median\_ns**: Median of all measured iterations (the primary statistic).
* **min\_ns**: Minimum across all iterations (useful for detecting lower bounds).
