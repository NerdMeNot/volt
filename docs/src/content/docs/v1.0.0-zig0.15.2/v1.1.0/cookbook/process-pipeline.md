...
description: Running subprocesses with Command and Child, capturing output,
  chaining commands, and adding timeouts.
slug: v1.0.0-zig0.15.2/v110/cookbook/process-pipeline
---
...
For independent steps, you could use [Parallel Tasks](/v1.0.0-zig0.15.2/cookbook/parallel-tasks) to run them concurrently.
