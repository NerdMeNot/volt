---
title: Echo Server
description: A complete TCP echo server that accepts multiple clients
  concurrently and echoes data back.
slug: v1.0.0-zig0.15.2/v110/cookbook/echo-server
---
