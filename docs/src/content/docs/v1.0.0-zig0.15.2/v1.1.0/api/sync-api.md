...
description: API reference for Mutex, RwLock, and Semaphore in Volt. For Notify,
  Barrier, and OnceCell, see the Coordination API.
slug: v1.0.0-zig0.15.2/v110/api/sync-api
---
...
For coordination primitives (Notify, Barrier, OnceCell), see the [Coordination API](/v1.0.0-zig0.15.2/api/coordination-api/).
...
For Notify, Barrier, OnceCell, thread safety details, and the full "Choosing the Right Primitive" guide, see the [Coordination API](/v1.0.0-zig0.15.2/api/coordination-api/).
