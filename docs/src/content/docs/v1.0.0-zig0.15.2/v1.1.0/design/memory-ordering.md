...
description: Atomic memory orderings used throughout Volt, why each was chosen,
  and how correctness is verified through loom-style testing.
slug: v1.0.0-zig0.15.2/v110/design/memory-ordering
---
...
[Channel Wakeup Protocol](/v1.0.0-zig0.15.2/design/channel-wakeup-protocol/) for the full
analysis.
...
4. **MPMC channel Dekker pattern (ARM64 deadlock):** The
   ...
   `.seq_cst`. See [Channel Wakeup Protocol](/v1.0.0-zig0.15.2/design/channel-wakeup-protocol/).
