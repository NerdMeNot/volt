...
Volt brings the same architecture that powers [Tokio](https://tokio.rs/) in Rust to Zig, adapted for Zig's value semantics and comptime specialization. Zero-allocation waiters, lock-free channels, and O(1) worker waking make it fast. An explicit `Io` handle (no hidden globals) makes it predictable. It is the I/O counterpart to [Blitz](https://github.com/NerdMeNot/blitz) (CPU parallelism), the same way Tokio complements Rayon.
...
<Tabs>
  <TabItem label="Channels">
    | Benchmark | Volt | Tokio | Speedup |
    |-----------|----------|-------|---------|
    | Channel send | 2.7 ns | 5.9 ns | 2.2x |
    | Channel recv | 6.3 ns | 9.6 ns | 1.5x |
    | Channel roundtrip | 6.3 ns | 12.5 ns | 2.0x |
    | Oneshot | 4.1 ns | 15.2 ns | 3.8x |
    | Broadcast (4 recv) | 22.9 ns | 50.3 ns | 2.2x |
    | Watch | 13.3 ns | 44.1 ns | 3.3x |
  </TabItem>
  <TabItem label="Coordination">
    | Benchmark | Volt | Tokio | Speedup |
    |-----------|----------|-------|---------|
    | OnceCell get | 0.4 ns | 0.6 ns | 1.4x |
    | OnceCell set | 9.6 ns | 29.2 ns | 3.0x |
    | Barrier | 15.6 ns | 359.2 ns | 23.1x |
    | Notify | 9.8 ns | 9.3 ns | Tie |
  </TabItem>
  <TabItem label="Synchronization">
    | Benchmark | Volt | Tokio | Speedup |
    |-----------|----------|-------|---------|
    | Mutex (uncontended) | 6.6 ns | 7.9 ns | 1.2x |
    | RwLock read | 6.7 ns | 7.8 ns | 1.2x |
    | RwLock write | 6.4 ns | 8.1 ns | 1.3x |
    | Semaphore | 6.4 ns | 7.5 ns | 1.2x |
    | Mutex contended (4 tasks) | 53.5 ns | 76.9 ns | 1.4x |
    | RwLock contended (4R+2W) | 50.0 ns | 97.2 ns | 1.9x |
  </TabItem>
  <TabItem label="Task Scheduling">
    | Benchmark | Volt | Tokio | Speedup |
    |-----------|----------|-------|---------|
    | Spawn + await | 6,459 ns | 7,819 ns | 1.2x |
    | Spawn batch (100) | 100.1 ns | 246.7 ns | 2.5x |
  </TabItem>
</Tabs>

**Overall: Volt leads on 17 of 21 benchmarks** (3 Tokio wins, 1 tie). Memory: 282 B/op total vs Tokio's 1,868 B/op -- **6.6x less**. Allocations: 3.0/op vs 17.1/op. Volt's architecture is [derived from Tokio](https://github.com/NerdMeNot/volt/blob/main/BENCHMARKS.md#standing-on-tokios-shoulders) -- we would not be here without their work. See [Comparing with Tokio](/testing/comparing-with-tokio/) for methodology and [full results](https://github.com/NerdMeNot/volt/blob/main/BENCHMARKS.md).
