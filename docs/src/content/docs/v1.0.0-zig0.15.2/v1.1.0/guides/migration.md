...
slug: v1.0.0-zig0.15.2/v110/guides/migration
---
...
| File I/O (no io\_uring) | Yes | Blocking syscall on some platforms |
...
| Network I/O | No | Already async via kqueue/epoll/io\_uring |
