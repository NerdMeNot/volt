...
description: Concurrent task patterns with Group, race, and select for health
  checks, speculative execution, and fan-out work.
slug: v1.0.0-zig0.15.2/v110/cookbook/parallel-tasks
---
...
The chunk-based approach ensures even distribution. If items have highly variable processing times, consider using a channel-based work queue instead (see [Producer/Consumer](/v1.0.0-zig0.15.2/cookbook/producer-consumer)) so fast workers can steal from slow ones.
